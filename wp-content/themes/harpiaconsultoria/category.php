<?php get_header(); ?>
    ...
    <section class="blog section">
        <div class="container pt-4 d-flex flex-column flex-md-row flex-wrap align-items-stretch">
            <div class="flex-fill row d-flex flex-wrap pe-md-4 order-md-1 order-2 content-area justify-content-start align-items-start">
                <?php 
                    if ( have_posts() ) {
                        ?>
